...
var RoxHome = func() string {
	home, err := os.UserHomeDir()
	if err != nil {
		home = "."
	}
	return filepath.Join(home, ".rox")
}()

func ConfigPath() string { return filepath.Join(RoxHome, "config.json") }
func EnvPath() string    { return filepath.Join(RoxHome, ".env") }
...
func SaveEnvFile(keys map[string]string) error {
	...
	b.WriteString("# Generated by RoX — do not commit\n\n")
